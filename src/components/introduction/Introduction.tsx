  ...
  <section id={id} className="wrapper style1 fullscreen fade-up">
    <div className="inner">
      ...
      {/* <!-- Quick link to resume https://webapps.stackexchange.com/questions/48061/can-i-trick-github-into-displaying-the-pdf-in-the-browser-instead-of-downloading --> */}
        <li>
          <a href="https://nbviewer.jupyter.org/github/blakermchale/resume/blob/master/resume.pdf" class="button scrolly">
            Resume
          </a>
        </li>
        <li>
          <a href="mailto:mchale.b@northeastern.edu" class="button scrolly">
            E-mail
          </a>
        </li>
        {/* <!-- TODO: ul only stacks at 480px width, so buttons will go off screen if there are more than 3 --> */}
        <li>
          <a href="https://github.com/blakermchale/" class="button scrolly">
            Github
          </a>
        </li>
        <li>
          <a href="https://gitlab.com/mchale.b" class="button scrolly">
            Gitlab
          </a>
        </li>
        <li>
          <a href="https://www.linkedin.com/in/blake-mchale-7b3703150/" class="button scrolly">
            LinkedIn
          </a>
        </li>
      </ul>
